...
import { StatusBar, Text, TextInput, View, TouchableOpacity, KeyboardAvoidingView, TouchableWithoutFeedback, Platform, Keyboard, Dimensions, ScrollView, Modal, Pressable } from 'react-native'
import { signUPWithEmailAndPass } from '../api/firebase/auth'
...
export default function Register({ navigation: { reset } }) {
  ...
  const [buttonsOff, setButtonOff] = useState('flex')
  ...
  const signUp = () => {
    ...
    if (!name && !lastname && !email && !password) {
      ...
      if (name && lastname && email && password) {
        signUPWithEmailAndPass({ name: name, lastname: lastname, email: email, password: password })
      }
    }
  }
  return (
        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <View style={[Styles.viewBackground]}>
            ...
            <View style={Styles.viewInput}>
              <TextInput keyboardType='ascii-capable' autoCorrect={false} style={Styles.textInput} placeholder="Name" placeholderTextColor={miss.name} value={name} onChangeText={(e) => { setname(e) }}></TextInput>
              <TextInput keyboardType='ascii-capable' autoCorrect={false} style={Styles.textInput} placeholder="Lastname" placeholderTextColor={miss.lastname} value={lastname} onChangeText={(e) => { setlastname(e) }}></TextInput>
